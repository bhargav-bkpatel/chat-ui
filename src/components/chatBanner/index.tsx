            ...
            <div className="w-full mt-[17px]">
              ...
              <div className='flex flex-col items-end pr-4'>
                ...
                <div className='flex items-start gap-4 pl-4 my-4'>
                    ...
                    <Image src={"/images/cheatavatar1.svg"} alt='img' width={32} height={32} className='' />
                    < div className='bg-[#F2F2F7] rounded-[6px] px-[8px] py-[4px] flex flex-col  relative'>
                        <Image src={"/images/chateIconeGray.svg"} alt='img' width={15} height={39} className='absolute top-0 left-[-9px]' />
                ...
                <div className='flex items-start  pl-4 mt-4'>
                    <div className='flex flex-col gap-3'>
                        <div className='flex items-start gap-4'>
                            <Image src={"/images/cheatavatar2.svg"} alt='img' width={32} height={32} className='' />
                            < div className='bg-[#F2F2F7] rounded-[6px] px-[8px] py-[4px] flex flex-col  relative'>
                                <Image src={"/images/chateIconeGray.svg"} alt='img' width={15} height={39} className='absolute top-0 left-[-9px]' />
                                <div className='flex items-center gap-[10px]'>
                        ...
                        <div className='flex items-start gap-4'>
                            ...
                            < div className='bg-[#F2F2F7] rounded-[6px] px-[8px] py-[4px] flex flex-col  relative'>
                                ...
                                <div className='flex items-center gap-[4px]'>
                                    <span className='text-sm text-[#2C2C2E] '>But limited vegan options @Janet!</span>
                                    <div className='flex items-center justify-end gap-[4px] mt-[21px]'>
                ...
                <div className='flex items-start  pl-4 mt-4'>
                    <div className='flex flex-col gap-3'>
                        <div className='flex items-start gap-4'>
                            <Image src={"/images/cheatavatar3.svg"} alt='img' width={32} height={32} className='' />
                            < div className='bg-[#F2F2F7] rounded-[6px] px-[8px] py-[4px] flex flex-col  relative'>
                                <Image src={"/images/chateIconeGray.svg"} alt='img' width={15} height={39} className='absolute top-0 left-[-9px]' />
                                <div className='flex items-center gap-[10px]'>
                        ...
                        <div className='flex items-start gap-4'>
                            <Image src={"/images/cheatavatar4.svg"} alt='img' width={32} height={32} className='' />
                            < div className='bg-[#F2F2F7] rounded-[6px] px-[8px] py-[4px] flex flex-col  relative'>
                                <Image src={"/images/chateIconeGray.svg"} alt='img' width={15} height={39} className='absolute top-0 left-[-9px]' />
                                <div className='flex items-center gap-[10px]'>
                                    <span className='text-[#2C2C2E] font-semibold text-sm'>Janet</span>
